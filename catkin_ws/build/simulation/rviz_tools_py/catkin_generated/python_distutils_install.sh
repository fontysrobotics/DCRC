...
echo_and_run cd "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/src/simulation/rviz_tools_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/src/simulation/rviz_tools_py/setup.py" \
     \
    build --build-base "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/build/simulation/rviz_tools_py" \
    install \
    --root="${DESTDIR-/}" \
