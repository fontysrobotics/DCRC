...
add_custom_target(blackboard_generate_messages ALL)
...
_generate_module_cpp(blackboard
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/blackboard
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(blackboard_generate_messages_cpp
...
add_custom_target(blackboard_gencpp)
add_dependencies(blackboard_gencpp blackboard_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS blackboard_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(blackboard
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/blackboard
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(blackboard_generate_messages_eus
...
# target for backward compatibility
add_custom_target(blackboard_geneus)
add_dependencies(blackboard_geneus blackboard_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS blackboard_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(blackboard
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/blackboard
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(blackboard_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(blackboard_genlisp)
add_dependencies(blackboard_genlisp blackboard_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS blackboard_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(blackboard
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/blackboard
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(blackboard_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(blackboard_gennodejs)
add_dependencies(blackboard_gennodejs blackboard_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS blackboard_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(blackboard
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/blackboard
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(blackboard_generate_messages_py
...
# target for backward compatibility
add_custom_target(blackboard_genpy)
add_dependencies(blackboard_genpy blackboard_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS blackboard_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/blackboard)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/blackboard
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(blackboard_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()
if(TARGET geometry_msgs_generate_messages_cpp)
  add_dependencies(blackboard_generate_messages_cpp geometry_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/blackboard)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/blackboard
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(blackboard_generate_messages_eus std_msgs_generate_messages_eus)
endif()
if(TARGET geometry_msgs_generate_messages_eus)
  add_dependencies(blackboard_generate_messages_eus geometry_msgs_generate_messages_eus)
endif()

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/blackboard)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/blackboard
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(blackboard_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()
if(TARGET geometry_msgs_generate_messages_lisp)
  add_dependencies(blackboard_generate_messages_lisp geometry_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/blackboard)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/blackboard
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(blackboard_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
if(TARGET geometry_msgs_generate_messages_nodejs)
  add_dependencies(blackboard_generate_messages_nodejs geometry_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/blackboard)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/blackboard\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/blackboard
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/blackboard/.+/__init__.pyc?$"
  )
endif()
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(blackboard_generate_messages_py std_msgs_generate_messages_py)
endif()
if(TARGET geometry_msgs_generate_messages_py)
  add_dependencies(blackboard_generate_messages_py geometry_msgs_generate_messages_py)
endif()
