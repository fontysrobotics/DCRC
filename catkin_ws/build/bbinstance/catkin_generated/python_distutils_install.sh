...
echo_and_run cd "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/src/bbinstance"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/src/bbinstance/setup.py" \
     \
    build --build-base "/home/ubuntu/ros2_bridge_custom_interfaces/ros1ws/build/bbinstance" \
    install \
    --root="${DESTDIR-/}" \
